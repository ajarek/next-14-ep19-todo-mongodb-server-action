...
const Update = async ({ params }: { params: { id: string } })=> {
  ...
  return (
   ...
   />
   <Button type="submit"  size={'lg'} className='text-xl'>Update</Button>
   </div>
   <div className='mt-10'>
    <Link className='bg-violet-500 text-white hover:bg-violet-400 px-6 py-4 rounded-lg  text-xl' href='/'>Close</Link>
   </div>
 </div>
    </form>
  )
